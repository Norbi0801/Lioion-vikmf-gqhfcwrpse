...
##  Podsumowanie  ##
  ...
  2. Liczba tagów, którą użył *Ash* jest około 3,5 raza większa niż pozostali najaktywniesi użytkownicy w wybranych forach.
  ...
  3. Serial *Gambit Królowej* wpłynął pozytywnie na wzrost zapytań na forum oraz pozytywnie wzrost odpowiedzi, po premierze filmu na *Netflixie*.
  4. Na podstawie zastosowanego wskaźnika do porównania popularności forów wnioskujemy, że bezapelacyjnym zwycięzcą jest forum *Arquade*.
